...
{
    internal class P10DataParameter
    {
    }
    public class P10UploadData : PlcUploadData
    {
        // 布尔信号 (0.0~1.0)
    ...
    /// <summary>
    /// PLC上传数据类，包含从PLC上传的各种数据
    /// </summary>
    public class PlcUploadData
    {
        // public short StationStatus { get; set; }    // 2.0 工站状态（Int16）
        // public short AlarmWord { get; set; }        // 4.0 报警字（Int16）
        //  public string Barcode1 { get; set; } = "";  // 6.0 工件条码信息1（String[50]）
